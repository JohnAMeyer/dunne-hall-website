	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="col-md-10 col-md-offset-1" style="background-color: #fff">
				<div class="row-fluid">
					<h1 class="text-center">Tacos</h1>
					<img class="img-responsive center-block" src="http://placehold.it/400x400"></div>
					<p class="indented">
					...
					<p class="indented">
						Boudin ham ham hock capicola filet mignon tongue burgdoggen pork chop corned beef drumstick jowl rump alcatra. Pork belly burgdoggen picanha ball tip shank strip steak short ribs doner ham meatball kielbasa capicola chicken. Tenderloin doner meatloaf, capicola pork chop chuck tri-tip ground round beef porchetta venison bacon pig burgdoggen cow. Chuck beef ribs flank rump pork chop ham bresaola pork jowl ham hock salami. Biltong sirloin beef ribs chicken, corned beef spare ribs cupim beef burgdoggen drumstick ball tip flank.
					</p>
				</div>
			</div>
		</div>
